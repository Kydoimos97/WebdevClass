...
$image = substr($_SERVER['REQUEST_URI'], strpos($_SERVER['REQUEST_URI'], "=") + 1);
                ...
                <div class="row d-flex justify-content-center align-items-baseline h-95">
                    <div class="col-xl-10">
                        <div class="card rounded-3 text-black ">
                            <div class="row g-0">
                                <div class="card w-5 transparent-divider border-0 pl-5 d-flex justify-content-center">
                                    <a href="KPIList.php">
                                ...
                                <div class="card w-90 page-title border-0 center-block ">
                                    <p class="detail-title pt-3 pb-3 border-bottom"><?php echo $kpiName ?></p>
                                </div>
                            ...
                            <div class="row g-0">
                                <div class="card-body p-md-4 mx-md-4 card-detail-picture">
                                    <img alt="Product Image" class="img-responsive"
                                         src=<?php echo 'CSS/Images/KPI/' . $image; ?>>
                                </div>
                            </div>
